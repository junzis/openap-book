...
- [Simple optimal flights](basic.qmd): explains how you can easily generate fuel and other simple cost-optimal trajectories.
- [Wind optimal flights](wind.qmd): provides two approaches to obtaining wind fields and using them in your optimization.
- [Using cost grids](costgrid.qmd): dives deeper into optimization with more complex 3D or 4D grids.
- [Contrails](contrails.qmd): provides a concrete example of flight optimization considering contrails.
- [Command-line interface](cli.qmd): running the optimizer and precomputing grid caches from the shell.
