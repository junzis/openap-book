...
The source of the example data is obtained from the following paper:
<https://gmd.copernicus.org/articles/16/3313/2023/gmd-16-3313-2023.html>

The example contrail temperature (ATR20) is calculated and is stored in a netCDF file, which can be downloaded using the following code:
...
This deviation costs about 850 kg of fuel, which accounts for 12% extra fuel when compared to the optimal case. This is a significant amount of fuel, both in terms of cost and excess CO2 emissions.
